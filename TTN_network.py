...
class TTNNetwork(nn.Module):
    def __init__(self, beta1, beta2, lr, SQUARED_GRAD_MOMENTUM, MIN_SQUARED_GRAD, n_actions, input_dims=10,in_channels=4, number_unit=128, num_units_rep=128, chkpt_dir='Online', name='Online'):

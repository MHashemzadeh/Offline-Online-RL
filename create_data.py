...
if __name__ == "__main__":
    ...
    parser.add_argument('--offline_online_training', type=str, default='online')  #offline or online or offline_online

    ############################################################
    ############################################################
    ## for fqi learning:
    parser.add_argument('--tr_alg_type', type=str, default='fqi')
    parser.add_argument('--tr_hyper_num', type=int, default=22) #seaquest=15, asterix=15 , breakout=15 , freeway=15  , space_invaders=22
    ...
    parser.add_argument('--en', type=str, default='space_invaders')  # # seaquest, asterix , breakout , freeway  , space_invaders

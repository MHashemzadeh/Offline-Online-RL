...
# @jit(target='cuda')
def train_offline_online(data_dir,featurepath, starting_state_path, alg_type, hyper_num, data_length_num, mem_size, num_rep, offline, fqi_rep_num, num_step_ratio_mem, en,
...
def train_offline(data_dir,featurepath, starting_state_path, alg_type, hyper_num, data_length_num, mem_size, num_rep, offline, fqi_rep_num, num_step_ratio_mem, en,
          feature, method_sarsa, num_updates_pretrain, num_iteration, num_epi_per_itr,
                          num_updates, fqi_reg_type, rnd):
            ...
            while episodes < num_epi_per_itr+1:
                ...
                if done:
                    ...
                    if count_10epi == num_epi_per_itr:
                        ...
                        for j in range(num_updates):
                            if TTN:
                                nn.learn_pretrain()  #loss = nn.learn()
                            else:  # DQN
                                loss = nn.learn()
...
#     parser.add_argument('--dirfeature', type=str, default='dir24') #loading batch data for feature learning
...
#
#     ## for fqi learning:
#     parser.add_argument('--method_sarsa', type=str,
#                         default='expected-sarsa')  # expected-sarsa, q-learning :--> #method for updating fqi
#
#     parser.add_argument('--regularizer', type=str, default='prev') # l2, prev :--> type of regularizer for fqi
#     parser.add_argument('--num_updates_pretrain', type=int, default=1)
#     parser.add_argument('--dir', type=str, default=dir24)  # loading the batch data
#     parser.add_argument('--featurepath', type=str, default='..//featuredqn_acrobot_dir21_10000.pt')
#     parser.add_argument('--num_updates_pretrain', type=int, default=1)
#     parser.add_argument('--num_iteration', type=int, default=100)
#     parser.add_argument('--num_epi_per_itr', type=int, default=50)
#     parser.add_argument('--starting_state_path', type=str, default='"..//LunarLander_test_states_random_dir15_numstates_2000.npy"')
#     parser.add_argument('--num_updates', type=int, default=1)
#
#
#     args = parser.parse_args()
#
#     main(args.algo, args.hyper_num, args.data_length_num, args.mem_size, args.num_rep, args.offline, args.fqi_rep_num,
#          args.num_step_ratio_mem, args.en, args.dirfeature, args.feature,
#          args.method_sarsa, args.featurepath, args.num_updates_pretrain, args.num_iteration, args.num_epi_per_itr, args.starting_state_path,
#          args.num_updates)
#
# # 15, -3 .... 12, -4,....  15, -4
